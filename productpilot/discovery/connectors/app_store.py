"""App Store review connector using local seed data."""
...
class AppStoreConnector(SourceConnector):
    source_name = SourceName.APP_STORE.value
    ...
    def fetch(self) -> list[NormalizedRecord]:
        ...
        for item in payload:
            ...
            content_hash = NormalizedRecord.build_content_hash(SourceName.APP_STORE, item["text"], item["url"])
            records.append(
                NormalizedRecord(
