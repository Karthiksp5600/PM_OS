...
class SourceName(str, Enum):
    ...
    CRAWLEE = "crawlee"
    KAGGLE_MYNTRA_APP_REVIEWS = "kaggle_myntra_app_reviews"
    KAGGLE_MYNTRA_FASHION = "kaggle_myntra_fashion"
    KAGGLE_MYNTRA_FASHION_PRODUCTS = "kaggle_myntra_fashion_products"
    KAGGLE_MYNTRA_SALES = "kaggle_myntra_sales"
    KAGGLE_MYNTRA_FASHION_PRODUCT = "kaggle_myntra_fashion_product"
    KAGGLE_MYNTRA_PRODUCTS = "kaggle_myntra_products"
    MAXCRAWL = "maxcrawl"
    APP_STORE = "app_store"
    YOUTUBE = "youtube"
    TWITTER_X = "twitter_x"
